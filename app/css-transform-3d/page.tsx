  ...
  return (
    <div className="flex min-h-screen w-full flex-col items-center justify-center text-5xl *:flex *:h-screen *:w-full *:flex-col *:items-center *:justify-center *:gap-10">
      ...
      <div>
        ...
        <div className="h-fit w-fit border-4 border-blue-500 bg-gray-900 p-10 duration-500 perspective-near hover:rotate-x-45">Normal div element</div>
      </div>
      <div>
        <h2>Hover: Rotate X Y Z 45 deg</h2>
        <div className="h-fit w-fit border-4 border-blue-500 bg-gray-900 p-10 duration-500 perspective-near hover:rotate-x-45 hover:rotate-y-45 hover:rotate-z-45">
          Normal div element
        </div>
      </div>
    </div>
